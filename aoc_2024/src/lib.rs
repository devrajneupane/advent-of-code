...
pub fn get_solution(day: &str, part: &str) -> Result<String, String> {
    ...
    match (day, part) {
        ...
        ("09", "1") => Ok(day09::part_one(&input).to_string()),
        ("09", "2") => Ok(day09::part_two(&input).to_string()),
        ("10", "1") => Ok(day10::part_one(&input).to_string()),
        ("10", "2") => Ok(day10::part_two(&input).to_string()),
        ("11", "1") => Ok(day11::part_one(&input).to_string()),
        ("11", "2") => Ok(day11::part_two(&input).to_string()),
        ("12", "1") => Ok(day12::part_one(&input).to_string()),
        ("12", "2") => Ok(day12::part_two(&input).to_string()),
        ("13", "1") => Ok(day13::part_one(&input).to_string()),
        ("13", "2") => Ok(day13::part_two(&input).to_string()),
        ("14", "1") => Ok(day14::part_one(&input).to_string()),
        ("14", "2") => Ok(day14::part_two(&input).to_string()),
